    ...
    <section className="bg-[#f4f4f4] pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-20">
        <div className="relative bg-[#F79400] rounded-[30px] px-12 py-8 md:py-10 flex flex-col md:flex-row items-center justify-between shadow-2xl">
          ...
          {/* Text */}
          <div className="md:ml-56 text-white">
            <h2 className="text-5xl font-bold mb-3">
              Ready to Park Smarter?
            </h2>

            <p className="text-xl max-w-xl text-white/95">
              Download the Vervoer app and find your perfect
              parking spot today!
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-12">
              ...
              <div>
                ...
                <div className="space-y-4 text-2xl">
                  <a href="#parking" className="block hover:text-[#F79400]">
                    Parking Services
                  </a>

                  <a href="#laundry" className="block hover:text-[#F79400]">
                    Laundry Services
                  </a>

                  <a href="#download" className="block hover:text-[#F79400]">
                    Download The App
                  </a>

                  <a href="#" className="block hover:text-[#F79400]">
                    Privacy Policy
                  </a>
                </div>
              </div>
                ...
                <div className="space-y-5 text-xl">
                  <p>
                    ...
                    <a
                      ...
                      className="underline hover:text-[#F79400]"
                    >
